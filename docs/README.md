...
2. **Källkod:** Redigera dokumenten i sandlådan.
3. **Versionshantering:** Se guiden i `.planning/docs/VERSIONING.md` för information om hur du skapar frysta snapshots (t.ex. v1.0.0) av innehållet.
